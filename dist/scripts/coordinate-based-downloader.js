...
async function getOrCreateScraperSession() {
    ...
    const scraper = new improved_turnitin_scraper_service_1.ImprovedTurnitinScraperService(true); // Headless = true
...
async function coordinateBasedDownloader(invokedTargetWorkTitle, invokedSubmissionId) {
    ...
    try {
        ...
        if (globalLoggedInPage && isSessionActive) {
            try {
                await (globalScraperInstance === null || globalScraperInstance === void 0 ? void 0 : globalScraperInstance.navigateToTurnitinInbox(globalLoggedInPage));
...
async function findWorkAndOpenAIReport(scraper, page, searchCriteria, searchType, projectDownloadPath) {
    ...
    try {
        ...
        const urlSubmissionId = (_a = cartaUrl.match(/[?&]o=(\d+)/)) === null || _a === void 0 ? void 0 : _a[1];
        if (urlSubmissionId) {
...
async function waitForCompletePageLoad(page) {
    ...
    try {
        ...
        console.log(`✅ Viewport configurado: ${viewport === null || viewport === void 0 ? void 0 : viewport.width}x${viewport === null || viewport === void 0 ? void 0 : viewport.height}`);
    }
    catch (error) {
...
async function visualDownloadStrategy(page, projectDownloadPath) {
    ...
    console.log(`📐 Viewport confirmado: ${viewport === null || viewport === void 0 ? void 0 : viewport.width}x${viewport === null || viewport === void 0 ? void 0 : viewport.height}`);
